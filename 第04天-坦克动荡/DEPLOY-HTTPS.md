...
cp ~/tank-trouble/deploy/nginx-tank.conf /etc/nginx/conf.d/tank.conf
...
cd ~/tank-trouble
# 前台：node server.js
# 或：pm2 restart tank-trouble / pm2 start server.js --name tank-trouble
```
